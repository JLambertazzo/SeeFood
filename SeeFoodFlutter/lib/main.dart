...
class MyEchoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyEchoHomePage(title: 'echoAR example app'),
    );
  }
}
...
class _MyEchoHomePageState extends State<MyEchoHomePage> {
  ...
  void _incrementCounter() async {
    if (widget.echoAR == null)
      widget.echoAR = EchoAR(apiKey: "solitary-smoke-3045");
    String imageLink = await widget.echoAR
        .getModelLinkFromEntryId("ead1c1c5-e9ed-4e9a-ab0a-e4508ddf9a9e");
